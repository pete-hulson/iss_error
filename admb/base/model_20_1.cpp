 ...
 *(ad_comm::global_datafile) >>  data_file; 
 ...
 if (nyrs_cpue>0) mean_obs_cpue = exp(mean(log(obs_cpue))); 
  ...
  iss_srv1_age.allocate(1,nyrs_srv1_age,"iss_srv1_age");
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  S.allocate(styr,endyr,1,nages_M,"S");
    ...
    S.initialize();
  #endif
  mat_a50.allocate(ph_mat,"mat_a50");
  mat_delta.allocate(ph_mat,"mat_delta");
