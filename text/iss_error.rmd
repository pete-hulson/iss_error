...
Compositional information on age and length are critical data products used in statistical catch-at-age assessment models as they facilitate the tracking of year classes and size-structure over time and improve our understanding of the population dynamics [@QuinnDeriso1999]. 
...
The concept of 'effective sample size' has been developed and implemented to reflect the increased uncertainty due to this overdispersion [e.g., @Mcallister1997], effective sample sizes are by design smaller than the collection sample size. 
