...
These stocks are also all assessed with SCAAmodels that require input sample sizes to 'weight' the age composition data fit in the stock assessment models. 
