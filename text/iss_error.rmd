...
Regardless of the source of composition data (whether fishery-independent for fishery-dependent), it is commonly accepted that overdispersion of the data is inherent due to intra-haul correlation [e.g., @Pennington1994; @Pennington2002]. 
...
Then, an ALK is constructed with age-length paired data and multiplied by the estimated population numbers-at-length to obtain estimated population numbers-at-age, often referred to as expanded age composition data [@Siskey2022]. 
...
This is often referred to as the 'first stage expansion' and is a common method to obtain population abundance estimates at length from area-swept survey data [e.g., ; @Ailloud2019].
...
# Discussion
*add a consequences of data weighting para somewhere*
